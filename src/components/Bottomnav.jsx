...
const Bottomnav = () => {
  ...
  return (
    <div>
      <div className="btm-nav px-[60px] py-4 flex justify-between items-center w-full shadow-md">
        <Link to="search">
          <button
            className="flex flex-col w-26 bg-primary text-white items-center justify-center rounded-full px-4 py-2 hover:bg-gray-600"
            onClick={handlePress}
          >
            <svg
