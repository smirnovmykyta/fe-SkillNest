...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (formData.password !== formData.confirmPassword) return setError("The passwords you entered do not match. Please make sure both passwords are the same.")

        const res = await registration(formData.email, formData.password, formData.username);
